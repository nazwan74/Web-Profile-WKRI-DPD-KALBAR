    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    @if($kegiatan->gambar)
                        <img src="{{ asset('storage/'.$kegiatan->gambar) }}" alt="Gambar" width="80">
                    @else
                        -
                    @endif
                </td>
                <td>
                    ...
                    <form action="{{ route('kegiatan.destroy', $kegiatan->id) }}" method="POST" class="form-hapus" style="display:inline-block;">
                        @csrf
                        @method('DELETE')
